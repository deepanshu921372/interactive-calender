  ...
  return (
    <div className="relative h-60 overflow-hidden bg-gray-200">
      ...
      >
        ...
        <polygon
          points="160,400 220,400 520,0 460,0"
          fill="#3498db"
          opacity="0.7"
        />
      </svg>
      ...
      <div className="absolute bottom-6 right-8 text-right z-10">
        <div className="text-5xl font-light text-white tracking-widest">
          {year}
        </div>
        <div className="text-3xl font-bold text-white tracking-widest mt-1">
